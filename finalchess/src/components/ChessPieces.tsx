...
export const Pawn: React.FC<ChessPieceProps> = ({ color, className = "w-full h-full" }) => {
  const isWhite = color === "w";
  return (
    <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
      {isWhite ? (
        <path
          fill="var(--piece-fill-white, #fff)"
          stroke="var(--piece-stroke, #000)"
          strokeLinecap="round"
          strokeWidth="1.5"
...
export const Rook: React.FC<ChessPieceProps> = ({ color, className = "w-full h-full" }) => {
  const isWhite = color === "w";
  return (
    <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
      {isWhite ? (
        ...
        >
          ...
          <path
            fill="none"
            stroke="var(--piece-internal-white, #ececec)"
...
export const Knight: React.FC<ChessPieceProps> = ({ color, className = "w-full h-full" }) => {
  const isWhite = color === "w";
  return (
    <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
      {isWhite ? (
        <g
          ...
          strokeWidth="1.5"
        >
          <path fill="var(--piece-fill-white, #fff)" d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21" />
          <path
            fill="var(--piece-fill-white, #fff)"
            d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3"
          />
          <path
            fill="var(--piece-stroke, #000)"
        ...
        <g
          ...
          strokeWidth="1.5"
        >
          <path fill="var(--piece-fill-black, #000)" d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21" />
          <path
            fill="var(--piece-fill-black, #000)"
          ...
          />
          <path
            fill="var(--piece-internal-white, #ececec)"
            stroke="var(--piece-internal-white, #ececec)"
...
export const Bishop: React.FC<ChessPieceProps> = ({ color, className = "w-full h-full" }) => {
  const isWhite = color === "w";
  return (
    <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
      {isWhite ? (
        <g
          ...
          strokeWidth="1.5"
        >
          <g fill="var(--piece-fill-white, #fff)" strokeLinecap="butt">
        ...
        <g
          ...
          strokeWidth="1.5"
        >
          <g fill="var(--piece-fill-black, #000)" strokeLinecap="butt">
          ...
          <path stroke="var(--piece-internal-white, #ececec)" strokeLinejoin="miter" d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" />
        </g>
      )}
    </svg>
  );
...
export const Queen: React.FC<ChessPieceProps> = ({ color, className = "w-full h-full" }) => {
  const isWhite = color === "w";
  return (
    <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
      {isWhite ? (
        ...
        <g
          ...
          strokeWidth="1.5"
        >
          <g stroke="none" fill="var(--piece-stroke, #000)">
...
export const King: React.FC<ChessPieceProps> = ({ color, className = "w-full h-full" }) => {
  const isWhite = color === "w";
  return (
    <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
      {isWhite ? (
        ...
        >
          ...
          />
          <path stroke="var(--piece-internal-white, #ececec)" d="M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0" />
        </g>
      )}
    </svg>
  );
